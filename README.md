...
Semantic HTML is the use of different elements to relay information on a browser. This includes headers, paragraphs, footers, navigation, and more.

2. What are the 4 areas of the box model?

The box model consists of a margin, a border, padding, and the content.

3. While using flexbox, what axis does the following property work on: ```align-items: center```?

It works horizontally along the cross axis.
 
4. Explain why git is valuable to a team of developers.

It is valuable because a team of developers can work on a single project without affecting each others changes until desired.

5. Define mobile-first design in your own words.

Mobile-first design is when a webpage is defaulted to fit on a mobile-sized screen.
